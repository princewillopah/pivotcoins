...
<section id="bg-referral">
    ...
    <section class="refsteps sections">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="head">
                        <h2>3 simple steps to refer a friend</h2>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="ref-steps-main">
                            <img src="img/generics/icon/refer.png" alt="">
        ...
        <div class="img1">
            <img src="img/referral/Faded-Arrow.png" alt="">
        </div>
        <div class="img2">
            <img src="img/referral/Faded-Arrow.png" alt="">
        </div>
