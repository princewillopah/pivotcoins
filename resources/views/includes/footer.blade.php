			...
			<div class="info">
				<div class="col-lg-6 col-lg-offset-3">
					<div class="heading text-center">
						<h3 class="heading-title" >{{$footer->site_name}}!</h3>
			...
			<div class="contacts">
				<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
					<div class="contacts-item">
						...
						<div class="content">
							<a href="#" class="title">{{$footer->contact_number}}</a>
				...
				<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
					<div class="contacts-item">
						...
						<div class="content">
							<a href="#" class="title">{{$footer->contact_email}}</a>
				...
				<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
					<div class="contacts-item">
						...
						<div class="content">
							<a href="#" class="title">Melbourne, Nigeria</a>
							<p class="sub-title">{{$footer->address}}</p>
						</div>
					</div>
				</div>
			</div>
